...
export const COMMANDS: Record<string, () => string[]> = {
  ...
  about: () => [
    ...
    "│           SOBRE MIM                     │",
    "├─────────────────────────────────────────┤",
    "│  Nome: Bruno Henrique Ramos Alves       │",
  ...
  projects: () => [
    ...
    "",
    "  [🎲] Chess System Java",
    "      Motor de xadrez em Java com interface e demonstração web",
    "      Stack: Java + POO + Estrutura de Dados + GitHub Pages",
    "      GitHub: github.com/fakezindev/chess-system-java",
    "",
    "  [🪪] Sistema de Crachá Desktop",
    "      Aplicação desktop em C# para confecção e gestão de crachás",
    "      Stack: C# + WPF + MVVM + MySQL + Git",
    "",
    "  [📺] LuxeForm Remodeling",
    "      Landing page corporativa americana para empresa de reformas",
    ...
    "      GitHub: github.com/fakezindev/fakeos",
    "",
  ],
  skills: () => [
