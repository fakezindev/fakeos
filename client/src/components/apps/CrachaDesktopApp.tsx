    ...
    <div className="h-full overflow-y-auto bg-background">
      ...
      <div className="relative p-6 bg-gradient-to-br from-blue-600/15 via-blue-500/5 to-transparent border-b border-border/30">
        ...
        <p className="text-xs text-muted-foreground mt-3 leading-relaxed max-w-lg">
          ...
          Pude aplicar na prática conceitos de arquitetura de software, organização de funcionalidades, manutenção de código e trabalho em equipa.
        </p>
            ...
            <div className="flex gap-1">
              {galleryScreens.map((_, i) => (
                <button
                  ...
                  className={`w-1.5 h-1.5 rounded-full transition-colors ${i === currentSlide ? "bg-blue-500 w-3" : "bg-white/30"}`}
                />
              ))}
            </div>
            <button
